...
signals:
    ...
    void signalButtonAdvanceClicked();
    void signalButtonBackClicked(QModelIndex);
...
private slots:
    ...
    void onButtonbackBtnCloseClicked();
public:

    QPushButton* advanceBtn;            // 前进按钮
    QPushButton* backBtn;               // 后退按钮
private:
