...
void MyTitleBar::initControl()
{
    ...
    advanceBtn->setFixedSize(QSize(BUTTON_WIDTH, BUTTON_HEIGHT));
    backBtn->setFixedSize(QSize(BUTTON_WIDTH, BUTTON_HEIGHT));
    ...
    advanceBtn->setObjectName("ButtonAdvance");
    backBtn->setObjectName("ButtonBack");
    ...
    mylayout->addWidget(advanceBtn);
    mylayout->addWidget(backBtn);
    qhb=NULL;
//    qhb = new QHBoxLayout(this);
//    qhb->addLayout(mylayout);
...
void MyTitleBar::initConnections()
{
    ...
    connect(advanceBtn, SIGNAL(clicked()), this, SLOT(onButtonAdvanceClicked()));
    connect(backBtn, SIGNAL(clicked()), this, SLOT(onButtonbackBtnCloseClicked()));
}
...
void MyTitleBar::paintEvent(QPaintEvent *event)
{
    ...
    QPainterPath pathBack; //绘制图形的一个容器
    ...
    if (this->width() != (this->parentWidget()->width() - m_windowBorderWidth))
    {
       this->setFixedWidth(this->parentWidget()->width() - m_windowBorderWidth);
        //只改变宽度，不改变高度
       // this->setFixedHeight(m_windowBorderWidth);
    }
...
void MyTitleBar::onButtonAdvanceClicked( )
{

    emit signalButtonAdvanceClicked();
}

void MyTitleBar::onButtonbackBtnCloseClicked( )
{
    QModelIndex index;
    emit signalButtonBackClicked(index);
}
